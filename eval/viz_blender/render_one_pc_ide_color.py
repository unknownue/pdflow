...
point_radius = 0.007   # For sota comparison
# point_radius = 0.005   # For banner
# point_radius = 0.007     # For airplane
...
coord_rot_total = np.matmul(coord_rot_y, coord_rot_x)
coord_rot_total = np.matmul(coord_rot_z, coord_rot_total)
...
scene.render.resolution_x = target_resolution # 2048
scene.render.resolution_y = target_resolution # 2048
