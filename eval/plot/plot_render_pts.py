...
# Usage: python plot_render_pts.py --input_xyz=path/to/input.xyz --gt_xyz=path/to/gt.xyz --output_path=path/to/output.png
...
BLENDER_PATH = Path('/workspace/Experiment/Denoise/deflow/eval/viz_blender/blender/blender')
BLEND_FILE_PATH = Path('/workspace/Experiment/Denoise/deflow/eval/viz_blender/point_clouds.blend')
RENDER_PY_PATH = Path('/workspace/Experiment/Denoise/deflow/eval/viz_blender/render_one_pc.py')

RGB_XYZ_TEM_PATH = Path('/workspace/Experiment/Denoise/deflow/eval/viz_blender/rendering.xyz')
